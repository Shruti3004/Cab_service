...
const dataSarnath = require("./data/sarnath.json");
const dataDurgaMandir = require("./data/durgaMandir.json");
...
app.get("/sarnath", (req, res) => {
  res.json(dataSarnath);
});
app.get("/durgaMandir", (req, res) => {
  res.json(dataDurgaMandir);
});
